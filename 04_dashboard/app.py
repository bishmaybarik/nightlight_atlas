...
# 🤖 Model Page
    ...
    st.markdown(
        ...
        **Interpretation:**
        ...
        - The plot shows a dense horizontal clustering around specific predicted values (70,000 and 110,000), indicating that the model is saturating its predictions within a narrow range, failing to capture the full variance in actual consumption.
